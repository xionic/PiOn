...
<paper-dialog id="dialog" always-on-top="" aria-describedby="simple-modal-content" aria-label="${this._getAriaLabel(this.title)}" aria-labelledby="${this._getAriaLabelledby(this.title)}" aria-modal="true" role="dialog" ?opened="${this.opened}" @opened-changed="${this.openedChangedEvent}" ?modal="${this.modal}" with-backdrop="">
  <div id="titlebar">
