!function (e, n) {
  ...
  var h = function (e) {
    ...
    return function (e, n) {
      ...
      value: function () {
        var e = this;
        c(r(o.prototype), "connectedCallback", this).call(this), setTimeout(function () {
      ...
      value: function () {
        window.removeEventListener("simple-modal-hide", this.close.bind(this)), window.removeEventListener("simple-modal-show", this.showEvent.bind(this)), c(r(o.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      key: "_resizeContent",
      value: function (e) {
      ...
      value: function (e, n, t) {
        ...
        var c = ["header", "content", "buttons"];

        for (var p in l ? this.setAttribute("id", l) : this.removeAttribute("id"), this.setAttribute("style", ""), r && ["--simple-modal-width", "--simple-modal-height", "--simple-modal-min-width", "--simple-modal-min-height", "--simple-modal-max-width", "--simple-modal-max-height", "--simple-modal-titlebar-color", "--simple-modal-titlebar-background", "--simple-modal-header-color", "--simple-modal-header-background", "--simple-modal-content-container-color", "--simple-modal-content-container-background", "--simple-modal-buttons-color", "--simple-modal-buttons-background", "--simple-modal-button-color", "--simple-modal-button-background"].forEach(function (e) {
          i.style.setProperty(e, r[e] || "unset");
        }), a ? this.setAttribute("class", a) : this.removeAttribute("class"), c) n[c[p]] && ((o = d ? n[c[p]].cloneNode(!0) : n[c[p]]).setAttribute("slot", c[p]), this.appendChild(o));

        setTimeout(function () {
          i.opened = !0, i.shadowRoot.querySelector("#close").focus(), i._resizeContent();
        }, 100);
      }
    }, {
      key: "animationEnded",
