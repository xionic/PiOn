...
import "../lib/simple-modal-template.js";</script>
    ...
    <div class="vertical-section-container centered">
      ...
      <demo-snippet>
        <template>
          ...
          <paper-button controls="smt1" on-tap="openModal">Button 1</paper-button>
          <simple-modal-template modal-id="smt1" title="simple-modal-template 1">
            ...
            <div slot="buttons"><paper-button dialog-dismiss="">Close Modal 1</paper-button></div>
          </simple-modal-template>
          <paper-button controls="smt2">Button 2</paper-button>
