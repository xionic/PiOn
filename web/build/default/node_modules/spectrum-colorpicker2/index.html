...
<div id="header">
    <h1><a href="http://seballot.github.com/spectrum">Spectrum</a></h1>
...
<div id="docs">
    ...
    <h2>Usage</h2>
    <h3>CDN</h3>
<pre>&lt;script src="https://cdn.jsdelivr.net/npm/spectrum-colorpicker2@2.0.0/dist/spectrum.min.js"&gt;
...
<pre>&lt;script src="spectrum.min.js"&gt;
...
<pre>$("#picker").spectrum({
    ...
    noColorSelectedText: string,
        ...
        <div class="option-content">
            ...
            <pre>&lt;input type='text' class='basic' value='red' /&gt;
...
$("input:disabled").spectrum({
    ...
    palette: [
        ...
        <div class="option-content">
            ...
            <pre>$("#togglePaletteOnly").spectrum({
    showPaletteOnly: true,
    ...
    palette: [
        ...
        <div class="option-content">
            ...
            <pre>$("#showSelectionPalette").spectrum({
    showPalette: true,
...
$("#showSelectionPaletteStorage").spectrum({
    ...
    maxSelectionSize: 2
        ...
        <div class="option-content">
            ...
            <pre>$("#hideAfterPaletteSelect").spectrum({
    showPaletteOnly: true,
    showPalette:true,
    ...
    palette: [
        ...
        <div class="option-content">
            ...
            <pre>$("#clickoutFiresChange").spectrum({
...
$("#clickoutDoesntChange").spectrum({
    ...
    showInitial: true
        ...
        <div class="option-content">
            ...
            <pre>$("#showInputAndInitial").spectrum({
    showInitial: true,
    showInput: true
});
            </pre>
        ...
        <div class="option-content">
            ...
            <pre>$("#showInputInitialClear").spectrum({
    allowEmpty:true,
    showInitial: true,
    showInput: true
});
    ...
    showButtons: false
        ...
        <div class="option-content">
            ...
            <pre>$("#containerClassName").spectrum({
...
.awesome {
    background: purple;
        ...
        <div class="option-content">
            ...
            <pre>$("#replacerClassName").spectrum({
...
<pre>// Events can be bound in the intialization process as options:
$("#picker").spectrum({
...
$("#picker").on('beforeShow.spectrum', function(e, tinycolor) { });
    ...
    return false; // Will never show up
        ...
        <div class="option-content">
            ...
            <pre>$(element).on("dragstart.spectrum", function(e, color) {
    color.toHexString(); // #ff0000
});
            </pre>
        ...
        <div class="option-content">
            ...
            <pre>$(element).on("dragstop.spectrum", function(e, color) {
    color.toHexString(); // #ff0000
});
            </pre>
...
$("#picker").spectrum("option", optionName, newOptionValue);
    ...
    return false;
        ...
        <div class="option-content">
            ...
            <pre>&lt;input type='text' value='blanchedalmond' name='triggerSet' id='triggerSet' /&gt;
...
<pre id="code-subheading">&lt;input type='color' name='color' /&gt;
...
<pre>var t = $("#element").spectrum("get");
t.toHex()       // "ff0000"
...
t.toName()      // "red"
    ...
    <div class="footer">
        ...
        <br>
        <a href="https://seballot.github.io/spectrum">JavaScript Colorpicker</a> |
        <a href="https://seballot.github.io/spectrum">jQuery Colorpicker</a> |
        <a href="https://seballot.github.io/spectrum">Mobile Colorpicker</a> |
        <a href="https://seballot.github.io/spectrum">Spectrum colorpicker</a>
        </p>
        <p>
        Thanks to all the <a href="https://github.com/seballot/spectrum/graphs/contributors">spectrum contributors</a> for committing code, documentation, and <a href="https://github.com/seballot/spectrum/tree/master/i18n">translations</a>.
        </p>
    </div>
