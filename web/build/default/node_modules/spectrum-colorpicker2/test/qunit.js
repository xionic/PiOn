...
(function (window) {
  ...
  QUnit.load = function () {
    ...
    moduleFilterHtml += "</select>"; // `userAgent` initialized at top of scope
  ...
  function validTest(test) {
    var include,
        ...
        fullName = (test.module + ": " + test.testName).toLowerCase(); // Internally-generated tests are always valid
