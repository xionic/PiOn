function updateBorders(color) {// do nothing
}
...
$(function () {
  ...
  $('#toc').toc({
    'selectors': 'h1,h2:not(.subtitle),h3',
  ...
  $("#pick1").spectrum({
    ...
    change: function (color) {
      ...
      var hex = color.toHexString(); //console.log("callback",color.toHslString(), color.toHsl().h, color.toHsl().s, color.toHsl().l)
  ...
  $("#showSelectionPaletteStorage").spectrum({
    ...
    // Any picker with the same string will share selection
    showSelectionPalette: true,
    palette: []
  });
