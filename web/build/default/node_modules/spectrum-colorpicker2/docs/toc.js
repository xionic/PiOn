  ...
  $.fn.toc = function (options) {
    ...
    return this.each(function () {
      ...
      headings.each(function (i, heading) {
        var $h = $(heading);
        headingOffsets.push($h.offset().top - opts.highlightOffset); //add anchor
        ...
        var a = $('<a/>').text($h.text()).attr('href', '#' + anchorName).bind('click', scrollTo);
        var li = $('<li/>').addClass(opts.prefix + '-' + $h[0].tagName.toLowerCase()).append(a);
        ul.append(li);
      });
      var el = $(this);
      el.html(ul);
