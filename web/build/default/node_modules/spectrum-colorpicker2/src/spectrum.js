...
(function (factory) {
  ...
  function spectrum(element, o) {
    ...
    var doc = element.ownerDocument,
        ...
        allowEmpty = opts.allowEmpty; // Element to be updated with the input color. Populated in initialize method

    var originalInputContainer = null,
        colorizeElement = null,
        colorizeElementInitialColor = null,
        colorizeElementInitialBackground = null; //If there is a label for this element, when clicked on, show the colour picker
    ...
    function initialize() {
      ...
      if (shouldReplace) {
        ...
        var addOn = $(["<div class='sp-colorize-container sp-add-on'>", "<div class='sp-colorize'></div> ", "</div>"].join(''));
        addOn.width(boundElement.outerHeight() + 'px').css('border-radius', boundElement.css('border-radius')).css('border', boundElement.css('border'));
      ...
      if (!!initialColor) {
        set(initialColor); // In case color was black - update the preview UI and set the format
    ...
    function updateOriginalInput(fireCallback) {
      ...
      if (fireCallback && hasChanged) {
        callbacks.change(color); // we trigger the change event or input, but the input change event is also binded
  ...
  */
  ...
  $.fn.spectrum = function (opts, extra) {
    ...
    return this.spectrum("destroy").each(function () {
      var options = $.extend({}, $(this).data(), opts); // Infer default type from input params and deprecated options

      if (!$(this).is('input')) options.type = 'noInput';else if (options.flat || options.type == "flat") options.type = 'flat';else if ($(this).attr('type') == 'color') options.type = 'color';else options.type = options.type || 'component';
