module.exports = function (grunt) {
  ...
  grunt.loadNpmTasks('grunt-contrib-concat'); // Testing tasks

  grunt.registerTask('test', ['jshint', 'qunit']); // Travis CI task.

  grunt.registerTask('travis', 'test'); // Default task.

  grunt.registerTask('default', ['test']); //Build Task.
