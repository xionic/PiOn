        ...
        if (warnings.length > 0) {
            ...
            if (errors.length > 0) {
                message += ` ${errors.length} ` +
                    `${chalk_1.default.red('error' + plural(errors.length))}`;
            }
            if (warningLevelWarnings.length > 0) {
                message += ` ${warningLevelWarnings.length} ` +
                    `${chalk_1.default.yellow('warning' + plural(warnings.length))}`;
            }
            if (infos.length > 0) {
                message += ` ${infos.length} ${chalk_1.default.green('info')} message` +
                    plural(infos.length);
            }
            if (fixable > 0) {
