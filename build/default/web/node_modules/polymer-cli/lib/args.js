...
exports.globalArguments = [{
  name: 'env',
  description: 'The environment to use to specialize certain commands, ' + 'like build',
  type: value => {
  ...
  type: String,
  multiple: true,
  description: 'Glob(s) that match your project source files. ' + 'Defaults to `src/**/*`.',
  group: 'global'
}, {
  name: 'extra-dependencies',
  type: String,
  multiple: true,
  description: 'Glob(s) that match any additional dependencies not caught ' + 'by the analyzer to include with your build.',
  group: 'global'
}, {
  name: 'npm',
  type: Boolean,
  description: 'Sets npm mode: dependencies are installed from npm, ' + 'component directory is "node_modules" and the package name is read ' + 'from package.json'
}, {
  name: 'module-resolution',
  description: 'Algorithm to use for resolving module specifiers in import ' + 'and export statements when rewriting them to be web-compatible. ' + 'Valid values are "none" and "node". "none" disables module specifier ' + 'rewriting. "node" uses Node.js resolution to find modules.',
  type: String,
  ...
  name: 'component-dir',
  type: String,
  description: 'The component directory to use. Defaults to reading from ' + 'the Bower config (usually bower_components/).'
}, {
  name: 'verbose',
...
exports.mergeArguments = mergeArguments; //# sourceMappingURL=args.js.map