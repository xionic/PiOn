...
class PolymerCli {
  constructor(args, configOptions) {
    this.commands = new Map(); // If the "--quiet"/"-q" flag is ever present, set our global logging
    ...
    if (typeof configOptions !== 'undefined') {
      ...
      this.defaultConfigOptions = polymer_project_config_1.ProjectConfig.loadOptionsFromFile('polymer.json');
    ...
    this.defaultConfigOptions.extraDependencies = this.defaultConfigOptions.extraDependencies || [];
  ...
  run() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let parsedArgs;
      logger.debug('running...'); // If the "--version" flag is ever present, just print
      ...
      try {
        ...
        if (error.name === 'INVALID_COMMAND') {
          ...
          }, new polymer_project_config_1.ProjectConfig(this.defaultConfigOptions));
      ...
      logger.debug(`command '${commandName}' found, parsing command args:`, {
        args: commandArgs
      });
      const commandDefinitions = args_1.mergeArguments([command.args, args_1.globalArguments]);
      const commandOptionsRaw = commandLineArgs(commandDefinitions, {
        argv: commandArgs
      });
      ...
      logger.debug(`final project configuration generated:`, config); // Help is a special argument for displaying help for the given command.
...
exports.PolymerCli = PolymerCli; //# sourceMappingURL=polymer-cli.js.map